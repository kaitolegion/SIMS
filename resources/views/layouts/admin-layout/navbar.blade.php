<nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow">
  ...
  <button class="btn btn-link btn-sm rounded-circle order-lg-0 me-4 me-lg-0 d-none d-lg-block" id="sidebarToggleTopFull">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
      ...
      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
        ...
        <a class="dropdown-item d-flex align-items-center" href="#">
          ...
          <div>
            <div class="small text-gray-500">June 20, 2023</div>
            A new student was enrolled!
          </div>
        </a>
    ...
    <li class="nav-item dropdown no-arrow">
      ...
      <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        <a class="dropdown-item" id="profile" href="/dashboard/profile">
